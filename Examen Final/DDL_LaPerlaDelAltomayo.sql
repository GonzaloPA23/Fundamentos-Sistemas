...
ALTER TABLE Pasaje
DROP CONSTRAINT PUFk; -- Elimina la clave externa existente

ALTER TABLE Pasaje
DROP CONSTRAINT PBFk
...
EXEC sp_rename 'Bus.AsientosDisponibles', 'CantidadAsiento', 'COLUMN';

SELECT * FROM Bus

Alter Table Pasaje
DROP COLUMN PuntoSalida, Destino, TipoBus, FechaSalida, Precio
